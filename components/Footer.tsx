...
import WhatsAppIcon, { WHATSAPP_GLYPH_PATH } from "@/components/WhatsAppIcon";
import { CONTACT_PHONE_DISPLAY, CONTACT_WHATSAPP_URL, whatsappUrl } from "@/lib/contact";
